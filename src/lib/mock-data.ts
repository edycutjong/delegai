...
export function createMockActivities(): ActivityEvent[] {
  ...
  return [
    ...
    },
    {
      ...
      type: 'ai_reasoning',
      agent: 'master',
      message: 'Venice AI: Allocating 10 USDC to Data Worker for market analysis and 10 USDC to Exec Worker for gasless relay — caveat-enforced limits prevent overspend.',
      timestamp: now + 750,
    },
    {
      id: 'evt-004',
    ...
    },
    {
      ...
      type: 'delegation_created',
      agent: 'master',
      message: 'EIP-7702 auth signed: Exec Worker EOA → StatelessDeleGator (0x000000000...) ',
      timestamp: now + 1750,
    },
    {
      id: 'evt-007',
    ...
    },
    {
      ...
      type: 'ai_reasoning',
      agent: 'data-worker',
      message: 'Venice AI insight: Market data shows strong momentum — BTC leading with +2.3% gain. Recommend executing relay transaction.',
      timestamp: now + 2750,
    },
    {
      id: 'evt-010',
      type: 'ai_reasoning',
      agent: 'exec-worker',
      message: 'Venice AI: Gas price of 0.0420 Gwei is within acceptable range — proceeding with UserOp submission via 1Shot relay.',
      timestamp: now + 2900,
    },
    {
      id: 'evt-011',
    ...
    },
    {
      ...
      timestamp: now + 4000,
      metadata: { txHash: '0xdemo7x4a5h000000000000000000000000000000000000000000000000dead' },
    },
    {
      id: 'evt-013',
      type: 'chain_settled',
